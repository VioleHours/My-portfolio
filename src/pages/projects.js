        ...
        <Layout className="pt-16">
          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32">
            <div className="col-span-12">
              <FeaturedProject
                title="Countries PI"
                summary="Individual Integrative Project
                In this project, I developed a Single Page Application (SPA) about countries and activities that can be created, assigned, and deleted. It also features combined filters, pagination, and controlled forms, among other things."
                link="/"
                type="Featured Project"
                img={project1}
                github="https://github.com/VioleHours/VioletaSol-PI"
              />
            </div>
